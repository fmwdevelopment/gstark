          ...
          showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                    ...
                    content: const NormalText(text:"Are you sure you want exit?"),
                    actions: [
                      // Close button
                      TextButton(
                        onPressed: () {
                        ...
                        child: const NormalText(text: "Yes",),
                      ),
                      Container(
                        ...
                        child: TextButton(
                          ...
                          child: const NormalText(text:"No",textColor: kWhite,),
                        ),
                      ),
                    ]);
              });
                                                                        ...
                                                                        children: [
                                                                          TextFormField(
                                                                            ...
                                                                            decoration:
                                                                              ...
                                                                              labelText: 'Product Name',
                                                                              labelStyle: TextStyle(color: kNeutral600),
                                                                              // Set initial label text color
                                                                              fillColor: kApplicationThemeColor,
                                                                              focusedBorder: UnderlineInputBorder(
                                                                                borderSide: BorderSide(color: kApplicationThemeColor),
                                                                              ),
                                                                    ...
                                                                    TextButton(
                                                                      onPressed:
                                                                        ...
                                                                        if (_formKey
                                                                          ...
                                                                          setState(
                                                                              () {
                                                                            generateInvoiceController.dataList.replaceRange(index,
                                                                                index + 1, [
                                                                              RxList<String>([
                                                                                _productNameController.text,
                                                                                _quantityController.text,
                              ...
                              Button(
                                  onPress: () async {
                                    if (_customerNameController.text.isEmpty) {
                                      ...
                                      var phoneNumber =
                                          await CustomSharedPref.getPref(
                                              SharedPreferenceString
                                                  .phoneNumber);
                                      File pdfFile =
                                          await generator.generateInvoicePdf(
                                              clientName,
                                      ...
                                      print(
                                          'Invoice PDF generated at: $pdfFile');
                              ...
                              Button(
                                onPress: () {
                                  if (generateInvoiceController.generatedPdf !=
                                    ...
                                    errorToast(
                                        "Generate Invoice First", context);
                                  }
                                },
